...
export default function WhatsApp() {
  return (
    <a href={WA} target="_blank" rel="noopener noreferrer" aria-label="Escríbenos por WhatsApp"
      className="fixed bottom-6 right-6 z-40 hidden h-14 w-14 place-items-center rounded-full bg-[#25D366] shadow-[0_10px_30px_rgba(0,0,0,.28)] transition hover:scale-110 lg:grid">
